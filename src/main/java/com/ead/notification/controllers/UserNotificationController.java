...
public class UserNotificationController {
    ...
    public ResponseEntity<Object> updateNotifications(@PathVariable(value = "userId")UUID userId,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(notificationService
                .updateNotification(notificationRecordDto, notificationService.findByNotificationIdAndUserId(notificationId, userId).get()));
    }
}
